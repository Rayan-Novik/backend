...
export const tenantResolver = async (req, res, next) => {
    ...
    try {
        ...
        // 🛠️ CORREÇÃO: Se o frontend enviar o domínio completo no slug, pegamos apenas a primeira parte
        if (slug && slug !== 'undefined' && slug.includes('.')) {
            slug = slug.split('.')[0]; // Transforma "santos-streetwear.azun.com.br" em "santos-streetwear"
        }
