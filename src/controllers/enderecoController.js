...
export const listarEnderecos = async (req, res, next) => {
    try {
        ...
        const enderecos = await EnderecoService.getUserAddresses(id_usuario, req.tenantId);
...
export const adicionarEndereco = async (req, res, next) => {
    try {
        const id_usuario = req.user.id_usuario;
        const novoEndereco = await EnderecoService.createAddress(id_usuario, req.body, req.tenantId);
...
export const removerEndereco = async (req, res, next) => {
    try {
        ...
        await EnderecoService.deleteAddress(Number(id_endereco), id_usuario, req.tenantId);
...
export const atualizarEndereco = async (req, res, next) => {
    try {
        ...
        const enderecoAtualizado = await EnderecoService.updateAddress(Number(id_endereco), id_usuario, req.body, req.tenantId);
