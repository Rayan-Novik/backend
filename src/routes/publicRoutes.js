...
import { getActiveCampaigns, getCampaignBySlug, trackCampaignClick, getFacebookProductFeed, postarNoFeed, criarCampanhaPaga} from '../controllers/custom/marketingController.js';
import { getProfissionaisPublicos, getPublicConfig } from '../controllers/custom/publicController.js';
...
router.get('/configuracoes/:chave', getPublicConfig);

router.get('/profissionais', getProfissionaisPublicos);
